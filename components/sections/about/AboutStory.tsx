...
export default function AboutStory() {
  return (
    <section className="py-24 md:py-32 px-6 bg-zinc-900 relative">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 md:gap-24 items-center">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative w-full aspect-square md:aspect-4/5 bg-black/40 rounded-[40px] overflow-hidden border border-white/10 backdrop-blur-sm"
        >
          <div className="absolute inset-0 bg-linear-to-tr from-[#660DFF]/20 to-transparent" />
          <div className="absolute bottom-10 left-10 w-32 h-32 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10" />
          <div className="absolute top-10 right-10 w-20 h-20 bg-[#B36EE6]/20 backdrop-blur-md rounded-full border border-white/10" />
        </motion.div>
