...
export default function AboutCTA() {
  return (
    <section className="relative py-40 px-6 text-center bg-transparent overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <p className="opacity-60 text-lg md:text-xl mb-12 max-w-2xl font-medium">
          Ready to be part of the decentralized future? Explore our platform and start your journey today.
        </p>
        <div className="border border-current/10 rounded-full p-2 bg-black/5 backdrop-blur-md hover:bg-black/10 transition-colors duration-300">
          <MagneticButton>
            <span className="px-8 py-4 block font-bold uppercase tracking-widest text-sm">
              Explore Platform
            </span>
          </MagneticButton>
        </div>
