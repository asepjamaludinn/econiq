...
export const articlesData: ArticleData[] = [
  {
    id: "1",
    title: "Mengenal Web3: Panduan Fundamental Pemula",
    excerpt:
      "Pahami pergeseran paradigma internet dari sentralisasi ke era desentralisasi yang memberdayakan kedaulatan digital Anda.",
    topic: "Fundamental Web3",
    readTime: "5 mnt baca",
    date: "01 Sep 2025",
  ...
  {
    id: "2",
    title: "Anatomi Blockchain: Cara Kerja & Konsep Dasarnya",
    excerpt:
      "Bongkar lapisan kompleksitas buku besar digital di balik revolusi Web3 tanpa jargon teknis yang membingungkan.",
    topic: "Teknologi",
    readTime: "5 mnt baca",
    date: "03 Sep 2025",
  ...
  {
    id: "4",
    title: "Crypto Wallet: Kunci Menuju Dunia Desentralisasi",
    excerpt:
      "Pahami arsitektur dompet digital, komparasi Hot vs Cold wallet, dan esensi krusial di balik kepemilikan kriptografi.",
    topic: "Dompet Digital",
    readTime: "7 mnt baca",
    date: "07 Sep 2025",
  ...
  {
    id: "7",
    title: "Evolusi Internet: Dari Web1 Menuju Era Web3",
    excerpt:
      "Jelajahi garis waktu peradaban internet—dari era pasif membaca hingga fase revolusioner kepemilikan aset digital utuh.",
    topic: "Sejarah",
    readTime: "6 mnt baca",
    date: "18 Sep 2025",
  ...
  {
    id: "8",
    title: "Ilusi Keamanan: Mitos & Fakta Seputar Crypto Wallet",
    excerpt:
      "Apakah aset digital Anda benar-benar aman? Kami membedah ilusi peretasan dan mengungkap urgensi di balik frasa pemulihan.",
  ...
  {
    id: "9",
    title: "Green Blockchain: Menuju Ekosistem Web3 Berkelanjutan",
    excerpt:
      "Menjawab skeptisisme lingkungan. Pelajari inovasi Proof of Stake dan kontribusi Web3 dalam aksi pelestarian iklim global.",
    topic: "Keberlanjutan",
    readTime: "5 mnt baca",
    date: "08 Sep 2025",
  ...
  {
    id: "11",
    title: "Langkah Awal Membangun Smart Contract Pertamamu",
    excerpt:
      "Eksplorasi logika 'self-executing code' yang meredefinisi masa depan transaksi otonom tanpa perantara pihak ketiga.",
    topic: "Pengembangan",
    readTime: "5 mnt baca",
    date: "20 Sep 2025",
